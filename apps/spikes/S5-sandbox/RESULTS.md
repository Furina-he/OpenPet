...
| `tsc` 类型检查（node + renderer 两份 tsconfig） | ✅ | `pnpm --filter @desksoul/spike-s5 typecheck` |
...
> 跑：`ELECTRON_MIRROR=https://npmmirror.com/mirrors/electron/ pnpm --filter @desksoul/spike-s5 dev`
