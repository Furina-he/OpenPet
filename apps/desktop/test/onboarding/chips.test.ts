...
describe('C4 启动话术 chips', () => {
  ...
  it('含设计稿示例话术', () => {
    expect(STARTER_CHIPS).toContain('onboarding.chipMorning');
    expect(STARTER_CHIPS).toContain('onboarding.chipJoke');
    expect(STARTER_CHIPS).toContain('onboarding.chipName');
  });
});
