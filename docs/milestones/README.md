...
| **M8a** | 聊天体验（B1 浮层 + B2 双轨气泡 + J3 错误分级） | 🚧 代码完成；真窗/真 Key 待人工 | [`M8a/`](M8a/) — spec + plans + RESULTS + README |
| **M8b** | 桌面层（A1 交互 + A2 气泡 + A3 穿透 + A4 徽标/全屏） | 🚧 代码完成；真窗冒烟待人工 | [`M8b/`](M8b/) — spec + plans + RESULTS + README |
| **M8c** | 系统集成（J1 托盘 + J2 热键录制器 + J5 崩溃上报） | 🚧 代码完成（M8 整体收口）；真窗冒烟待人工 | [`M8c/`](M8c/) — spec + plans + RESULTS + README |
| M9 | 打包 + 体验打磨 + 文档 | ⏳ | 待建 |
